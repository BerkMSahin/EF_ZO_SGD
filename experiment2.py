...
parser.add_argument("--eta", default=0.5, help="Learning rate for SGD", type=float)
...
parser.add_argument("--N", default=5, help="Number of agents", type=int)
parser.add_argument("--R", default=20, help="Radius of agent's neighbor", type=int)
parser.add_argument("--lambda_list", default="1 3 5 7.5 10", help="Regularization term", type=str)
parser.add_argument("--init_size", default=80, help="Initialization size", type=int)
